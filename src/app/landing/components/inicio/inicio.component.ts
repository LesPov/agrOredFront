...
export class InicioComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  // ======================================================================== //
  public getZoneImageUrl(zone: ZoneData | null): string { if (!zone) return this.defaultTerritoryImage; const fn = zone.zoneImage?.trim(); if (fn) { try { return `${this.baseAssetUrl}uploads/zones/images/${encodeURIComponent(fn)}`; } catch (e) { console.error('Error encoding zone image URL', e); return this.defaultTerritoryImage; } } return this.defaultTerritoryImage; }
